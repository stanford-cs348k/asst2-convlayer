...
Note that the auto-scheduler is currently optimizing assuming the input dimensions hardcoded in `conv_layer_generators.cpp` (Please see [here](https://github.com/stanford-cs348k/asst2-convlayer/blob/6ef45fde827c1c8926fa820eeb0f7e98979fd401/conv_layer_generators.cpp#L116-L119).). If you compare performance against the autoscheduler for other size inputs you should probably change these parameters to the autoscheduler schedules specifically to these sizes. 
